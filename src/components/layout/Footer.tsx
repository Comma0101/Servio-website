...
const Footer: React.FC = () => {
  ...
  return (
    <footer className={`${darkMode ? 'bg-dark-bg' : 'bg-gray-900'} text-white transition-colors duration-300`}>
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="mb-8 md:mb-0">
            <h2 className="text-2xl font-bold text-indigo-400 mb-4">Servio</h2>
            <p className="text-gray-300 mb-4">
              Advanced conversational AI for restaurant ordering through natural language processing.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/documentation" className="text-gray-300 hover:text-white transition-colors duration-300">Documentation</Link></li>
              <li><Link to="/api" className="text-gray-300 hover:text-white transition-colors duration-300">API Reference</Link></li>
        ...
        <div className={`border-t ${darkMode ? 'border-gray-800' : 'border-gray-700'} mt-8 pt-8 text-center text-gray-400 transition-colors duration-300`}>
